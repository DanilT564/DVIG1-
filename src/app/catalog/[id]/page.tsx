...
const products = [
  {
    ...
    fullDescription: `
      Двигатель ЗМЗ-405 евро 3  - это бензиновый инжекторный двигатель, который устанавливается на легковые автомобили (например, ГАЗ-3110 Волга), коммерческий транспорт и внедорожники. 
      
      Мотор имеет рабочий объем 2,3 литра и развивает мощность 140-150 л.с. при 5200 об/мин. Крутящий момент составляет 214 Н⋅м при 4000 об/мин. 
      
      Что входит в восстановление: Блок цилиндров Оригинальный бу блок, прошедший Опрессовку на герметичность. Расточку под ремонтный размер. Продувку масляных каналов. ГБЦ (головка блока цилиндров) Ремонт с заменой 
      Новых прокладок (ГБЦ, клапанной крышки, поддона). Сальников (передний, задний). Притирка клапанов для герметичности. Восстановление резьбовых соединений. Поршневая группа Установка новых ремонтных поршней и колец.
      Контроль зазоров между поршнями и цилиндрами. Система ГРМ Установка новой цепи ГРМ и комплекта Идеальная фаза Евро-3 Киров. Проверка меток ГРМ для синхронизации коленвала и распредвала. Вспомогательные системы
    ...
    advantages: [
      'Низкая цена по сравнению с новым двигателем',
